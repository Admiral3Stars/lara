...
<div class="container">
    ...
    <main class="site-content">
        ...
        <h3 class="content-header">Categories list</h3>
        <?php foreach ($categories as $categoriesItem): ?>
            <div class="content-new">
                <strong><a href="<?=route('categories.show', ['id' => $categoriesItem['id']])?>"><?=$categoriesItem['title']?></a></strong>
                <p><?=$categoriesItem['description']?></p>
                <em>Автор: <?=$categoriesItem['autor']?></em>
                <hr>
            </div>
        <?php endforeach; ?>
